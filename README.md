...
### Interesting Java Syntax

- Curly braces
- Function declaration has words like public static void
- Print is System.out.println
- Program is a part of the FizzBuzz class
- For loop doesn't use an iterator object
